...
void HACDInterface::polygonMeshFromPointsTriangles(pcl::PolygonMesh& mesh,
...
void HACDInterface::pointsTrianglesFromPolygonMesh(const pcl::PolygonMesh& mesh,
...
vector<pcl::PolygonMesh::Ptr> HACDInterface::ConvexDecompHACD(const pcl::PolygonMesh& mesh, float concavity) {
